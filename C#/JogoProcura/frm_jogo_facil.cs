...
namespace JogoProcura
{
    public partial class frm_jogo_facil : Form
    {
        ...
        private void frm_jogo_Load(object sender, EventArgs e)
        {
            ...
            Random r = new Random();
            int R_height = r.Next(128, this.Height - 128); 
            int R_width = r.Next(128, this.Width - 128);
        ...
        {
            img_galinha.Image = JogoProcura.Properties.Resources.galinha_128;
            timer.Stop();
        ...
        private void frm_jogo_facil_KeyDown(object sender, KeyEventArgs e)
        {
