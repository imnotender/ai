...
{
    public partial class frm_jogo_medio : Form
    {
        public frm_jogo_medio()
        {
            InitializeComponent();
        }
        ...
        private void frm_jogo_Load(object sender, EventArgs e)
        {
            ...
            Random r = new Random();
            int R_height = r.Next(64, this.Height - 64); 
            int R_width = r.Next(64, this.Width - 64);
        ...
        {
            img_galinha.Image = JogoProcura.Properties.Resources.galinha_64;
            timer.Stop();
        ...
        private void frm_jogo_medio_KeyDown(object sender, KeyEventArgs e)
        {
